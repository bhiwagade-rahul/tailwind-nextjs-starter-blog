...
export const metadata = {
  ...
  description: 'Terms and Conditions for Desi Showbiz. Read our terms of service, user agreement, and website usage policies.',
}
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <div className="space-y-8">
            <section>
              ...
              <p>
                By accessing and using Desi Showbiz ("the Website"), you accept and agree to be bound by the terms
            ...
            <section>
              ...
              <p>
                Desi Showbiz is an entertainment news and information platform that provides content related to
                Bollywood, Hollywood, and entertainment industry news, reviews, and updates.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                of Desi Showbiz or its content suppliers and is protected by copyright and intellectual property laws.
              </p>

              <h3>User-Generated Content</h3>
              <p>
                By posting comments or other content on our Website, you grant us a non-exclusive, royalty-free,
                perpetual, and worldwide license to use, display, and distribute your content.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                The information on this Website is provided on an "as is" basis. We make no representations or
                warranties of any kind, express or implied, as to the operation of the Website or the information,
                content, or materials included herein.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Desi Showbiz will not be liable for any damages of any kind arising from the use of this Website,
            ...
            <section>
              <h2>8. Advertising</h2>
              <p>
                This Website may display advertisements. We are not responsible for the content of any advertisements
                or the products/services offered by advertisers. Your dealings with advertisers are solely between
            ...
            <section>
              ...
              <p>
                These Terms constitute the entire agreement between you and Desi Showbiz regarding the use of the Website
